...
public class MainActivity extends BaseActivity {
    ...
    protected void onResume() {
        super.onResume();
        Constant.LOG(TAG, UserInfo.getInstance().hp);
        Constant.LOG(TAG, UserInfo.getInstance().email);
        refresh();
...
//        Intent intent = new Intent(this, BoardActivity_backup.class); //  FAQ 다른 방식 백업
    ...
    public void btn_getToWorkClicked() {
        ...
        Utils.waitTwoSec(btn_getToWork);
        ...
        /*출근하기 누른 상태*/
            ...
            commuteConfirmDialog = new CommuteConfirmDialog(this, Utils.getNowDateDay(), Utils.getNowDate(),Utils.getNowTime(),
                    nowLatitude,nowLongitude, commuteCloseButtonListener, 1, "", "");
    ...
    public CommuteInfoAdapter.OnUserRollListButtonClickListener userRollListButtonClickListener = new CommuteInfoAdapter.OnUserRollListButtonClickListener() {
        ...
        public void onItemClick(View view, int position) {
            ...
            if(selectData.getAttIdx() != -1){
                ...
                if(UserInfo.getInstance().userCommuteState == 0){
                    ...
                    if(response.isSuccessful()){
                        ...
                        if(userAttendanceList.size() > 0){
                            ...
                            if(!UserInfo.getInstance().isFinRollList) {
                                ...
                                commuteConfirmDialog = new CommuteConfirmDialog(MainActivity.this, Utils.getNowDateDay(), Utils.getNowDate(),Utils.getNowTime(),
