...
public class FindPasswordDialog extends BaseDialog {
    ...
    public FindPasswordDialog(Context context, String title, String content, View.OnClickListener closeButtonListener) {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        FindPWFragment.instance.setPhoneAuthFin(false);
    }
}
