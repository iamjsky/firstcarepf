 ...
 *
 * Description          출퇴근 다이얼로그
 */

public class CommuteConfirmDialog extends BaseDialog {
    ...
    /*기존의 출퇴근하기, 출퇴근확인(**old**)*/
    public CommuteConfirmDialog(Context context, String title, String date, String time,
        ...
        attLatitude = latitude;
        attLongitude = longitute;
        ...
        if(type > 2) {
            ...
            Constant.LOG(TAG, "agencyName : " + agencyName + " locationName : " + locationName +
                    " agencyLatitude : " + agencyLatitude + " agencyLongitude : " + agencyLongitude);
...
// 줌 아웃
        ...
        if (commuteType < 3 && commuteType != 0) {
            ...
            agencyMarker.setItemName(agencyName);
