...
/**
 * ClassName            NoticeContentDialog
 * Created by JSky on   2020-06-26
 *
 * Description          공지사항 내용 다이얼로그 (백업)
 */

public class NoticeContentDialog extends BaseDialog {


    private View.OnClickListener confirmButtonListener;

    Context mContext;
    NoticeListModel mData;
    ...
    public NoticeContentDialog(Context context, NoticeListModel data, View.OnClickListener confirmButtonListener) {
