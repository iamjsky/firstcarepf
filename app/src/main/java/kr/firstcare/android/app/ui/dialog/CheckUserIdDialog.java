...
public class CheckUserIdDialog extends BaseDialog {
    ...
    public CheckUserIdDialog(Context context, String title, String content, View.OnClickListener closeButtonListener, boolean isFullScreen) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_check_userid);
